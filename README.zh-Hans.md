...
<img src="https://raw.githubusercontent.com/ryekee/RuaKey-releases/main/docs/zhs-dashboard.png" width="820" alt="RuaKey dashboard" />
...
<img src="https://raw.githubusercontent.com/ryekee/RuaKey-releases/main/docs/zhs-popover.png" align="right" width="300" alt="Menu bar popover" />
...
2. 正常打开 RuaKey。经过 **Developer ID 签名和 Apple 公证**的版本可直接通过 Gatekeeper；只有旧 ad-hoc 版本可能仍需执行一次**右键 → 打开**。
3. 按提示授予**输入监听**权限，然后**退出并重启一次**——macOS 要求重启 App 才能生效。

正式签名版通过 RuaKey 内置更新器安装，并保持同一 App 身份，不应再次要求输入监听权限。如果你从旧 ad-hoc 版本升级后权限仍被拒绝，请在**系统设置 ▸ 隐私与安全性 ▸ 输入监听**中移除旧 RuaKey 条目一次，再添加当前 App。
